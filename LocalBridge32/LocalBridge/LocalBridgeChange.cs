...
{
    class LocalBridgeChange
    {
        
       
            public static void _localbridgechange()
            {
                // string Hub_name;
                ...
                if (bowl1 >= 1 && bowl1 <= cardx.Count)
                {
                    ...
                    string arg = "/c cd \"" + directory + "\" && vpncmd.exe localhost:5555 /SERVER /PASSWORD:pirkon12 /CMD BridgeCreate BRIDGE /DEVICE:";
                    arg += crd_choosen;
